...
@sec-discussion explains and discusses the results in details. @sec-conclusion
...
Comparing the data set, it appears that certain categories, such as "DRIVE-SELF RENTAL OWNER" and "PRIVATE TRANSPORTATION COMPANY," consistently have lower endorsements frequencies, reflecting potential operational trends or regulatory considerations. The variations in endorsements numbers between the two time periods underscore the dynamic nature of endorsements activities across different business categories, suggesting changes 
