...
\begin{center}
$Issue\_duration=\beta_0 + \beta_1*Category + \beta_2*Num\_Endorsements + \epsilon$
\end{center}
where:
...
\begin{center}
$log(Issue\_duration)=\beta_0 + \beta_1*Category + \beta_2*log(Num\_Endorsements) + \epsilon$
\end{center}
where:
